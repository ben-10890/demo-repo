...
$sql = mysqli_query($con, "select * from room_booking_details where email='$email' ");
...
if (isset($savedata)) {
  ...
  if (mysqli_num_rows($sql)) {
    ...
    $sql = "insert into room_booking_details(name,email,phone,address,city,payment,zip,contry,room_type,Occupancy,check_in_date,check_in_time,check_out_date) 
  values('$name','$email','$phone','$address','$city','$payment','$zip','$country',
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <input type="text" value="<?php echo $result['name']; ?>" class="form-control" name="name" placeholder="Enter your name here" required>
                </div>
              </div>
            </div>
