...
<body style="margin-top:50px;">
  ...
  <div class="container-fluid" id="red">
    ...
    <div class="container text-center">
      <h1>Welcome To <font color="#a6e22b;"><b>Rainbow Ruiru Resort</b></font>
      </h1>
      <hr><br>
      <div class="row">
        <div class="hov">
          ...
          ?>
            ...
            <div class="col-sm-4" >
              <div class="row" style="height:350px; margin:2px;">
                <img src="image/Luxury_img8.jpg/<?php echo $r_res['image']; ?>" class="img-responsive thumbnail" alt="Image" id="img1" style="height: 150px;">
                <!--Id Is Img-->
