...
<footer style="background-color: #393939;">
	...
	<div class="col-sm-4 hov">
		<img src="logo/logo.png"width="60px"height="70px"/><br><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Ruiru, kiambu</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>hotel@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>0740843795</p><br><br><br>
     <center><img src="logo/logo.png"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
